...
ActiveRecord::Schema[7.0].define(version: 2024_11_08_142359) do
  ...
  create_table "m_payment_methods", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "orders", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "m_payment_method_id", null: false
    ...
    t.index ["m_payment_method_id"], name: "index_orders_on_m_payment_method_id"
  ...
  add_foreign_key "orders", "m_payment_methods"
