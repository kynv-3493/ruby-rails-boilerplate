  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Discount" do
        expect {
          post discounts_url, params: { discount: valid_attributes }
        }.to change(Discount, :count).by(1)
      end

      it "redirects to the created discount" do
        post discounts_url, params: { discount: valid_attributes }
        expect(response).to redirect_to(discount_url(Discount.last))
      end
    end
    ...
    context "with invalid parameters" do
      it "does not create a new Discount" do
        expect {
          post discounts_url, params: { discount: invalid_attributes }
        }.to change(Discount, :count).by(0)
      end
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested discount" do
        discount = Discount.create! valid_attributes
        patch discount_url(discount), params: { discount: new_attributes }
        discount.reload
      ...
      it "redirects to the discount" do
        ...
        patch discount_url(discount), params: { discount: new_attributes }
        discount.reload
        expect(response).to redirect_to(discount_url(discount))
      end
    end
    ...
    context "with invalid parameters" do
      it "renders a response with 422 status (i.e. to display the 'edit' template)" do
        discount = Discount.create! valid_attributes
        patch discount_url(discount), params: { discount: invalid_attributes }
        expect(response).to have_http_status(:unprocessable_entity)
      end
    end
  end
